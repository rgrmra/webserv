...
- **Non-Blocking I/O**: Uses `poll()` (or equivalents like `kqueue`/`epoll`) for efficient client-server communication.
...
- `make`
- Testing tools: `curl`, web browser, or custom scripts (Python/Go).
